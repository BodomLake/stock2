...
# 设置输出 log文件位置
logging.basicConfig(filename='../../log/stock-2020-09-19.log', filemode='a', level=logging.WARNING,
...
# stocks = [{'code': '300955', 'name': '新天绿能'}, {'code': '300725', 'name': '药石科技'}]
# 在 http://stockpage.10jqka.com.cn/ 的一些 股票 没有对应的财报信息
stocks = [{'code': '600956', 'name': '嘉亨家化'}]
